...
<div id="main_body">
    ...
    <div class="row">
        ...
        <div class="text-center col-md-6 col-lg-6 col-sm-12" id="div_veiculograma">
            <div class="inline">
                <h1>Seletor</h1><span>
            <hr>
            </div>
            ...
            <div class="input-group">
                ...
                <input id="texto_procuradov" type="text" class="form-control" aria-label="With textarea"
                       ...
                       onkeypress="filtrar_tags('texto_procuradov','divespveic','tag_veiculograma')">
            </div>
            <hr>
        ...
        <!-- MULTAS -->
        <div class="text-center col-md-6 col-lg-6 col-sm-12" id="div_multas">
            <div class="inline">
                <h1>Seletor</h1><span>
            <hr>
            </div>
            ...
            <div class="input-group">
                ...
                <input id="texto_procuradomu" type="text" class="form-control" aria-label="With textarea"
                       ...
                       onkeypress="filtrar_tags('texto_procuradomu','divespmult','tag_multas')">
            </div>
            <hr>
            <div id="divespmult" ondrop="drop(event)" ondragover="allowDrop(event)">
                ...
                for ($i = 0; $i < $k; $i++) {
                    echo "
               <button class='btn btn-success btn-sm tag_multas' role='button' title='Arraste para o lado para incluir no relatório.' draggable='true' ondragstart='drag(event)' id='$coluna_multas[$i]'>$coluna_multas[$i]</button>    
        ";
                }
                ?>
            </div>
        ...
        <!-- MANUTENCAO -->
        <div class="text-center col-md-6 col-lg-6 col-sm-12" id="div_manutencao">
            <div class="inline">
                <h1>Seletor</h1><span>
            <hr>
            </div>
            ...
            <div class="input-group">
                ...
                <input id="texto_procuradoma" type="text" class="form-control" aria-label="With textarea"
                       ...
                       onkeypress="filtrar_tags('texto_procuradoma','divespmanut','tag_manutencao')">
            </div>
            <hr>
            <div id="divespmanut" ondrop="drop(event)" ondragover="allowDrop(event)">
                ...
                for ($i = 0; $i < $k; $i++) {
                    echo "
               <button class='btn btn-success btn-sm tag_manutencao' role='button' title='Arraste para o lado para incluir no relatório.' draggable='true' ondragstart='drag(event)' id='$coluna_manutencao[$i]'>$coluna_manutencao[$i]</button>    
        ";
                }
                ?>
            </div>
        ...
        <!-- LOCACAO -->
        <div class="text-center col-md-6 col-lg-6 col-sm-12" id="div_locacao">
            <div class="inline">
                <h1>Seletor</h1><span>
            <hr>
            </div>
            ...
            <div class="input-group">
                ...
                <input id="texto_procuradol" type="text" class="form-control" aria-label="With textarea"
                       ...
                       onkeypress="filtrar_tags('texto_procuradol','divesploc','tag_locacao')">
            </div>
            <hr>
            <div id="divesploc" ondrop="drop(event)" ondragover="allowDrop(event)">
                ...
                for ($i = 0; $i < $k; $i++) {
                    echo "
               <button class='btn btn-success btn-sm tag_locacao' role='button' title='Arraste para o lado para incluir no relatório.' draggable='true' ondragstart='drag(event)' id='$coluna_locacao[$i]'>$coluna_locacao[$i]</button>    
        ";
                }
                ?>
            </div>
